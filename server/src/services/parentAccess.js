...
// a 23503 here means one of the two ids just doesn't exist in this company at all.
async function linkParent(req, body = {}) {
  ...
  try {
    ...
    if (err.code === '23503') throw new HttpError(400, 'parent or student not found in your company');
