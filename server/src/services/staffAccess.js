...
// impossible to insert; a 23503 here means one of the two ids just doesn't exist at all.
async function grantAccess(req, body = {}) {
  ...
  try {
    ...
    if (err.code === '23503') throw new HttpError(400, 'staff member or student not found in your school');
